...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 '-DMOZ_APP_BASENAME="Firefox"' '-DMOZ_APP_VENDOR="Mozilla"'
CPPSRCS += $(srcdir)/AutoProfilerLabel.cpp
CPPSRCS += $(srcdir)/AwakeTimeStamp.cpp
CPPSRCS += $(srcdir)/ConditionVariable_posix.cpp
CPPSRCS += $(srcdir)/MmapFaultHandler.cpp
CPPSRCS += $(srcdir)/Mutex_posix.cpp
CPPSRCS += $(srcdir)/Printf.cpp
CPPSRCS += $(srcdir)/ProcessType.cpp
CPPSRCS += $(srcdir)/RWLock_posix.cpp
CPPSRCS += $(srcdir)/RuntimeExceptionModule.cpp
CPPSRCS += $(srcdir)/SIMD.cpp
CPPSRCS += $(srcdir)/SIMD_avx2.cpp
CPPSRCS += $(srcdir)/SSE.cpp
CPPSRCS += $(srcdir)/StackWalk.cpp
CPPSRCS += $(srcdir)/TimeStamp.cpp
CPPSRCS += $(srcdir)/TimeStamp_posix.cpp
CPPSRCS += $(srcdir)/Uptime.cpp
CPPSRCS += $(srcdir)/decimal/Decimal.cpp
SIMD_avx2.cpp_FLAGS += -mavx2
