...
ShowSSEConfig_OBJS := /workspace/Odyssey/mozglue/tests/ShowSSEConfig.list
...
ShowSSEConfig: ShowSSEConfig.o \
    ...
    ../interposers/Unified_cpp_mozglue_interposers0.o \
...
TestBaseProfiler_OBJS := /workspace/Odyssey/mozglue/tests/TestBaseProfiler.list
...
TestIntegerPrintfMacros_OBJS := /workspace/Odyssey/mozglue/tests/TestIntegerPrintfMacros.list
...
TestPrintf_OBJS := /workspace/Odyssey/mozglue/tests/TestPrintf.list
