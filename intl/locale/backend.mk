...
dist_include_mozilla_intl_FILES += fluent_langneg_ffi_generated.h
dist_include_mozilla_intl_FILES += unic_langid_ffi_generated.h
dist_include_mozilla_intl_DEST := $(DEPTH)/dist/include/mozilla/intl
dist_include_mozilla_intl_TARGET := export
INSTALL_TARGETS += dist_include_mozilla_intl
