...
DIRS := gtest
CPPSRCS += $(srcdir)/WriteArgument.cpp
_tests_xpcshell_uriloader_exthandler_tests_unit_FILES += WriteArgument
_tests_xpcshell_uriloader_exthandler_tests_unit_DEST := $(DEPTH)/_tests/xpcshell/uriloader/exthandler/tests/unit
_tests_xpcshell_uriloader_exthandler_tests_unit_TARGET := misc
INSTALL_TARGETS += _tests_xpcshell_uriloader_exthandler_tests_unit
...
SIMPLE_PROGRAMS += WriteArgument
WriteArgument_OBJS := /workspace/Odyssey/uriloader/exthandler/tests/WriteArgument.list
WriteArgument: WriteArgument.list
WriteArgument: WriteArgument.o \
