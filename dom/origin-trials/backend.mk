...
PRE_COMPILE_TARGETS += $(MDDEPDIR)/keys.inc.stub
keys.inc: $(MDDEPDIR)/keys.inc.stub ;
EXTRA_MDDEPEND_FILES += $(MDDEPDIR)/keys.inc.pp
$(MDDEPDIR)/keys.inc.stub: /workspace/Odyssey/src/dom/origin-trials/gen-keys.py $(srcdir)/test.pub $(srcdir)/prod.pub
	$(REPORT_BUILD)
	$(call py_action,file_generate,/workspace/Odyssey/src/dom/origin-trials/gen-keys.py generate keys.inc $(MDDEPDIR)/keys.inc.pp $(MDDEPDIR)/keys.inc.stub $(srcdir)/test.pub $(srcdir)/prod.pub)
	@$(TOUCH) $@
...
UNIFIED_CPPSRCS := Unified_cpp_dom_origin-trials0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
dist_include_mozilla_FILES += origin_trials_ffi_generated.h
