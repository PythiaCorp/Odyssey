...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DCDM_IMPLEMENTATION
FINAL_TARGET = $(DEPTH)/dist/bin/gmp-fake/1.0
CPPSRCS += $(srcdir)/cdm-fake.cpp
CPPSRCS += $(srcdir)/cdm-test-decryptor.cpp
CPPSRCS += $(srcdir)/cdm-test-storage.cpp
