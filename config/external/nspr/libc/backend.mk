...
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/base64.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/plerror.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/plgetopt.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/plvrsion.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strcase.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strcat.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strchr.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strcmp.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strcpy.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strdup.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strlen.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strpbrk.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strstr.c
CSRCS += $(topsrcdir)/nsprpub/lib/libc/src/strtok.c
...
LIBRARY_NAME := plc4
FORCE_SHARED_LIB := 1
IMPORT_LIBRARY := libplc4.so
SHARED_LIBRARY := libplc4.so
DSO_SONAME := libplc4.so
LIB_IS_C_ONLY := 1
libplc4.so_OBJS := base64.o \
    plerror.o \
    plgetopt.o \
    plvrsion.o \
    strcase.o \
