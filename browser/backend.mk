...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DAPP_VERSION=110.0a1 -DMOZ_WIDEVINE_EME
DIST_SUBDIR = browser
FINAL_TARGET = $(if $(XPI_NAME),$(DIST)/xpi-stage/$(XPI_NAME),$(DIST)/bin)$(DIST_SUBDIR:%=/%)
DIRS := actors base components fonts fxr locales modules themes extensions branding app tools/mozscreenshots
