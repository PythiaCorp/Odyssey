...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DXPCOM_GLUE -DMOZ_HAS_MOZGLUE -DMOZ_GECKODRIVER '-DFIREFOX_ICO="/workspace/Odyssey/src/browser/branding/unofficial/firefox.ico"' '-DDOCUMENT_ICO="/workspace/Odyssey/src/browser/branding/unofficial/document.ico"' '-DNEWWINDOW_ICO="/workspace/Odyssey/src/browser/branding/unofficial/newwindow.ico"' '-DNEWTAB_ICO="/workspace/Odyssey/src/browser/branding/unofficial/newtab.ico"' '-DPBMODE_ICO="/workspace/Odyssey/src/browser/branding/unofficial/pbmode.ico"' '-DDOCUMENT_PDF_ICO="/workspace/Odyssey/src/browser/branding/unofficial/document_pdf.ico"'
...
COMPUTED_CFLAGS += -I/workspace/Odyssey/dist/system_wrappers -include /workspace/Odyssey/src/config/gcc_hidden.h -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fstack-protector-strong -fstack-clash-protection -DNDEBUG=1 -DTRIMMED=1 -DXPCOM_GLUE -DMOZ_HAS_MOZGLUE -DMOZ_GECKODRIVER '-DFIREFOX_ICO="/workspace/Odyssey/src/browser/branding/unofficial/firefox.ico"' '-DDOCUMENT_ICO="/workspace/Odyssey/src/browser/branding/unofficial/document.ico"' '-DNEWWINDOW_ICO="/workspace/Odyssey/src/browser/branding/unofficial/newwindow.ico"' '-DNEWTAB_ICO="/workspace/Odyssey/src/browser/branding/unofficial/newtab.ico"' '-DPBMODE_ICO="/workspace/Odyssey/src/browser/branding/unofficial/pbmode.ico"' '-DDOCUMENT_PDF_ICO="/workspace/Odyssey/src/browser/branding/unofficial/document_pdf.ico"' -I/workspace/Odyssey/src/browser/app -I/workspace/Odyssey/browser/app -I/workspace/Odyssey/build -I/workspace/Odyssey/src/toolkit/xre -I/workspace/Odyssey/src/xpcom/base -I/workspace/Odyssey/src/xpcom/build -I/workspace/Odyssey/dist/include -I/workspace/Odyssey/dist/include/nspr -I/workspace/Odyssey/dist/include/nss -include /workspace/Odyssey/mozilla-config.h -DMOZILLA_CLIENT -fPIC -fno-math-errno -pthread -pipe -gdwarf-4 -O2 -fno-omit-frame-pointer -funwind-tables -Wall -Wbitfield-enum-conversion -Wempty-body -Wformat-type-confusion -Wignored-qualifiers -Wpointer-arith -Wshadow-field-in-constructor-modified -Wsign-compare -Wtype-limits -Wno-error=tautological-type-limit-compare -Wunreachable-code -Wunreachable-code-return -Wunused-but-set-parameter -Wclass-varargs -Wfloat-overflow-conversion -Wfloat-zero-conversion -Wloop-analysis -Wno-range-loop-analysis -Wenum-compare-conditional -Wenum-float-conversion -Wstring-conversion -Wno-error=deprecated-declarations -Wno-error=array-bounds -Wno-error=free-nonheap-object -Wno-error=atomic-alignment -Wno-error=deprecated-builtins -Wformat -Wformat-security -Werror=implicit-function-declaration -Wno-psabi -Wthread-safety -Wno-unknown-warning-option -fno-strict-aliasing -ffp-contract=off
COMPUTED_CXXFLAGS += -I/workspace/Odyssey/dist/system_wrappers -include /workspace/Odyssey/src/config/gcc_hidden.h -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fstack-protector-strong -fstack-clash-protection -DNDEBUG=1 -DTRIMMED=1 -DXPCOM_GLUE -DMOZ_HAS_MOZGLUE -DMOZ_GECKODRIVER '-DFIREFOX_ICO="/workspace/Odyssey/src/browser/branding/unofficial/firefox.ico"' '-DDOCUMENT_ICO="/workspace/Odyssey/src/browser/branding/unofficial/document.ico"' '-DNEWWINDOW_ICO="/workspace/Odyssey/src/browser/branding/unofficial/newwindow.ico"' '-DNEWTAB_ICO="/workspace/Odyssey/src/browser/branding/unofficial/newtab.ico"' '-DPBMODE_ICO="/workspace/Odyssey/src/browser/branding/unofficial/pbmode.ico"' '-DDOCUMENT_PDF_ICO="/workspace/Odyssey/src/browser/branding/unofficial/document_pdf.ico"' -I/workspace/Odyssey/src/browser/app -I/workspace/Odyssey/browser/app -I/workspace/Odyssey/build -I/workspace/Odyssey/src/toolkit/xre -I/workspace/Odyssey/src/xpcom/base -I/workspace/Odyssey/src/xpcom/build -I/workspace/Odyssey/dist/include -I/workspace/Odyssey/dist/include/nspr -I/workspace/Odyssey/dist/include/nss -DMOZILLA_CLIENT -include /workspace/Odyssey/mozilla-config.h -fno-sized-deallocation -fno-aligned-new -fno-exceptions -fPIC -fno-rtti -fno-exceptions -fno-math-errno -pthread -pipe -gdwarf-4 -O2 -fno-omit-frame-pointer -funwind-tables -Wall -Wbitfield-enum-conversion -Wdeprecated-this-capture -Wempty-body -Wformat-type-confusion -Wignored-qualifiers -Wpointer-arith -Wshadow-field-in-constructor-modified -Wsign-compare -Wtype-limits -Wno-error=tautological-type-limit-compare -Wunreachable-code -Wunreachable-code-return -Wunused-but-set-parameter -Wno-invalid-offsetof -Wclass-varargs -Wempty-init-stmt -Wfloat-overflow-conversion -Wfloat-zero-conversion -Wloop-analysis -Wno-range-loop-analysis -Wc++2a-compat -Wenum-compare-conditional -Wenum-float-conversion -Wno-ambiguous-reversed-operator -Wno-error=deprecated -Wno-error=deprecated-anon-enum-enum-conversion -Wno-error=deprecated-enum-enum-conversion -Wno-error=deprecated-pragma -Wno-error=deprecated-this-capture -Wcomma -Wimplicit-fallthrough -Wstring-conversion -Wno-inline-new-delete -Wno-error=deprecated-declarations -Wno-error=array-bounds -Wno-error=free-nonheap-object -Wno-error=atomic-alignment -Wno-error=deprecated-builtins -Wformat -Wformat-security -Wno-psabi -Wthread-safety -Wno-unknown-warning-option -fno-strict-aliasing -ffp-contract=off
...
PROGRAM = $(DEPTH)/dist/bin/firefox
firefox_OBJS := /workspace/Odyssey/browser/app/firefox.list
$(DEPTH)/dist/bin/firefox: firefox.list
$(DEPTH)/dist/bin/firefox: nsBrowserApp.o \
