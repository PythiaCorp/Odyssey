...
PROGRAM = $(DEPTH)/dist/bin/logalloc-replay
logalloc-replay_OBJS := /workspace/Odyssey/memory/replace/logalloc/replay/logalloc-replay.list
$(DEPTH)/dist/bin/logalloc-replay: logalloc-replay.list
$(DEPTH)/dist/bin/logalloc-replay: Replay.o \
    Assertions.o \
    Poison.o \
    RandomNum.o \
    TaggedAnonymousMemory.o \
    Unused.o \
    StackWalk.o \
    Unified_cpp_logalloc_replay0.o \
    ../../../build/Unified_cpp_memory_build0.o \
    ../FdPrintf.o \
    ../LogAlloc.o \
    ../../dmd/Unified_cpp_memory_replace_dmd0.o \
    ../../phc/Unified_cpp_memory_replace_phc0.o
