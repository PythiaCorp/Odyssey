...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DMOZ_HAS_MOZGLUE -DMOZ_NO_MOZALLOC
CPPSRCS += $(srcdir)/SmokeDMD.cpp
...
SIMPLE_PROGRAMS += SmokeDMD
SmokeDMD_OBJS := /workspace/Odyssey/memory/replace/dmd/test/SmokeDMD.list
SmokeDMD: SmokeDMD.list
SmokeDMD: SmokeDMD.o \
    ../../../../mozglue/build/dummy.o \
    ../../../build/Unified_cpp_memory_build0.o \
    ../../logalloc/FdPrintf.o \
    ../../logalloc/LogAlloc.o \
    ../Unified_cpp_memory_replace_dmd0.o \
    ../../phc/Unified_cpp_memory_replace_phc0.o \
    ../../../mozalloc/cxxalloc.o \
    ../../../mozalloc/Unified_cpp_memory_mozalloc0.o \
