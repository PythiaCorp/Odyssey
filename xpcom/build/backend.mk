...
$(MDDEPDIR)/Services.cpp.stub: /workspace/Odyssey/src/xpcom/build/Services.py
	$(REPORT_BUILD)
	$(call py_action,file_generate,/workspace/Odyssey/src/xpcom/build/Services.py services_cpp Services.cpp $(MDDEPDIR)/Services.cpp.pp $(MDDEPDIR)/Services.cpp.stub)
	@$(TOUCH) $@
...
dist_include_mozilla_FILES += GeckoProcessTypes.h
