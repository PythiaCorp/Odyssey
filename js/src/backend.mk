...
DIRS := build debugger frontend gc irregexp jit util wasm intgemm ../../intl/components
LOCAL_INCLUDES += -I$(CURDIR)/ctypes/libffi/include
LOCAL_INCLUDES += -I$(srcdir)/ctypes/libffi/src/x86
CSRCS += $(srcdir)/vtune/ittnotify_static.c
CSRCS += $(srcdir)/vtune/jitprofiling.c
CPPSRCS += $(srcdir)/builtin/RegExp.cpp
CPPSRCS += $(srcdir)/ctypes/CTypes.cpp
CPPSRCS += $(srcdir)/ctypes/Library.cpp
CPPSRCS += $(srcdir)/jsmath.cpp
CPPSRCS += $(srcdir)/vm/Interpreter.cpp
CPPSRCS += $(srcdir)/vm/ProfilingStack.cpp
CPPSRCS += $(srcdir)/vtune/VTuneWrapper.cpp

# We build files in 'unified' mode by including several files
# together into a single source file.  This cuts down on
# compilation times and debug information size.
UNIFIED_CPPSRCS := Unified_cpp_js_src0.cpp Unified_cpp_js_src1.cpp Unified_cpp_js_src10.cpp Unified_cpp_js_src11.cpp Unified_cpp_js_src12.cpp Unified_cpp_js_src13.cpp Unified_cpp_js_src14.cpp Unified_cpp_js_src15.cpp Unified_cpp_js_src16.cpp Unified_cpp_js_src17.cpp Unified_cpp_js_src18.cpp Unified_cpp_js_src19.cpp Unified_cpp_js_src2.cpp Unified_cpp_js_src20.cpp Unified_cpp_js_src21.cpp Unified_cpp_js_src22.cpp Unified_cpp_js_src23.cpp Unified_cpp_js_src24.cpp Unified_cpp_js_src25.cpp Unified_cpp_js_src3.cpp Unified_cpp_js_src4.cpp Unified_cpp_js_src5.cpp Unified_cpp_js_src6.cpp Unified_cpp_js_src7.cpp Unified_cpp_js_src8.cpp Unified_cpp_js_src9.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
ittnotify_static.c_FLAGS += -Wno-varargs
ittnotify_static.c_FLAGS += -Wno-sign-compare
ittnotify_static.c_FLAGS += -Wno-unknown-pragmas
dist_include_FILES += js-config.h
dist_include_DEST := $(DEPTH)/dist/include/
dist_include_TARGET := export
INSTALL_TARGETS += dist_include
dist_include_js_FILES += $(DEPTH)/mozglue/baseprofiler/public/ProfilingCategoryList.h
dist_include_js_DEST := $(DEPTH)/dist/include/js
dist_include_js_TARGET := export
INSTALL_TARGETS += dist_include_js
