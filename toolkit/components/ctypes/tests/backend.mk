...
LOCAL_INCLUDES += -I$(topsrcdir)/js/src/ctypes

# We build files in 'unified' mode by including several files
# together into a single source file.  This cuts down on
# compilation times and debug information size.
UNIFIED_CPPSRCS := Unified_cpp_ctypes_tests0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
_tests_testing_mochitest_chrome_toolkit_components_ctypes_tests_chrome_FILES += libjsctypes-test.so
_tests_testing_mochitest_chrome_toolkit_components_ctypes_tests_chrome_DEST := $(DEPTH)/_tests/testing/mochitest/chrome/toolkit/components/ctypes/tests/chrome
_tests_testing_mochitest_chrome_toolkit_components_ctypes_tests_chrome_TARGET := misc
INSTALL_TARGETS += _tests_testing_mochitest_chrome_toolkit_components_ctypes_tests_chrome
_tests_xpcshell_toolkit_components_ctypes_tests_unit_FILES += libjsctypes-test.so
_tests_xpcshell_toolkit_components_ctypes_tests_unit_DEST := $(DEPTH)/_tests/xpcshell/toolkit/components/ctypes/tests/unit
_tests_xpcshell_toolkit_components_ctypes_tests_unit_TARGET := misc
INSTALL_TARGETS += _tests_xpcshell_toolkit_components_ctypes_tests_unit
NO_DIST_INSTALL := 1
