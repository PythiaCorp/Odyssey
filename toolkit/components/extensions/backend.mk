...
DIRS := schemas storage webidl-api webrequest
...
UNIFIED_CPPSRCS := Unified_cpp_extensions0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
misc::
	$(call py_action,buildlist,$(DEPTH)/dist/bin/chrome.manifest 'manifest components/extensions-toolkit.manifest')
JAR_MANIFEST := /workspace/Odyssey/src/toolkit/components/extensions/jar.mn
