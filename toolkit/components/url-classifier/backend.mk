...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DGOOGLE_PROTOBUF_NO_RTTI -DGOOGLE_PROTOBUF_NO_STATIC_INITIALIZER -DMOZ_SAFEBROWSING_DUMP_FAILED_UPDATES -DOS_POSIX=1 -DOS_LINUX=1
DIRS := tests
...
UNIFIED_CPPSRCS := Unified_cpp_url-classifier0.cpp
