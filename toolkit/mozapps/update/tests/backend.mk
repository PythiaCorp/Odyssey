...
SIMPLE_PROGRAMS += TestAUSHelper
TestAUSHelper_OBJS := /workspace/Odyssey/toolkit/mozapps/update/tests/TestAUSHelper.list
TestAUSHelper: TestAUSHelper.list
TestAUSHelper: TestAUSHelper.o \
    ../common/city.o \
    ../common/commonupdatedir.o \
    ../common/readstrings.o \
    ../common/updatecommon.o
SIMPLE_PROGRAMS += TestAUSReadStrings
TestAUSReadStrings_OBJS := /workspace/Odyssey/toolkit/mozapps/update/tests/TestAUSReadStrings.list
TestAUSReadStrings: TestAUSReadStrings.list
TestAUSReadStrings: TestAUSReadStrings.o \
    ../common/city.o \
    ../common/commonupdatedir.o \
    ../common/readstrings.o \
    ../common/updatecommon.o
