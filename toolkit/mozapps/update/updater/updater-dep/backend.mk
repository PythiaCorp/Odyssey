...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DDEP_UPDATER -DSPRINTF_H_USES_VSNPRINTF -DNS_NO_XPCOM '-DMAR_CHANNEL_ID=""' '-DMOZ_APP_VERSION="110.0a1"'
...
PROGRAM = $(DEPTH)/_tests/updater-dep/updater-dep
updater-dep_OBJS := /workspace/Odyssey/toolkit/mozapps/update/updater/updater-dep/updater-dep.list
$(DEPTH)/_tests/updater-dep/updater-dep: updater-dep.list
$(DEPTH)/_tests/updater-dep/updater-dep: archivereader.o \
    progressui_gtk.o \
    updater.o \
