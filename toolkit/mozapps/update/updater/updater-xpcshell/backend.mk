...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DTEST_UPDATER -DSPRINTF_H_USES_VSNPRINTF -DNS_NO_XPCOM '-DMAR_CHANNEL_ID=""' '-DMOZ_APP_VERSION="110.0a1"'
...
updater-xpcshell_OBJS := /workspace/Odyssey/toolkit/mozapps/update/updater/updater-xpcshell/updater-xpcshell.list
