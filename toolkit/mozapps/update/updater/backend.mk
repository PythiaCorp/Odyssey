...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DSPRINTF_H_USES_VSNPRINTF -DNS_NO_XPCOM '-DMAR_CHANNEL_ID=""' '-DMOZ_APP_VERSION="110.0a1"'
...
PROGRAM = $(DEPTH)/dist/bin/updater
updater_OBJS := /workspace/Odyssey/toolkit/mozapps/update/updater/updater.list
$(DEPTH)/dist/bin/updater: updater.list
$(DEPTH)/dist/bin/updater: archivereader.o \
    progressui_gtk.o \
    updater.o \
