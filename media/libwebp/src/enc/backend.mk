...
CSRCS += $(srcdir)/alpha_enc.c
CSRCS += $(srcdir)/analysis_enc.c
CSRCS += $(srcdir)/backward_references_cost_enc.c
CSRCS += $(srcdir)/backward_references_enc.c
CSRCS += $(srcdir)/config_enc.c
CSRCS += $(srcdir)/cost_enc.c
CSRCS += $(srcdir)/filter_enc.c
CSRCS += $(srcdir)/frame_enc.c
CSRCS += $(srcdir)/histogram_enc.c
CSRCS += $(srcdir)/iterator_enc.c
CSRCS += $(srcdir)/near_lossless_enc.c
CSRCS += $(srcdir)/picture_csp_enc.c
CSRCS += $(srcdir)/picture_enc.c
CSRCS += $(srcdir)/picture_rescale_enc.c
CSRCS += $(srcdir)/picture_tools_enc.c
CSRCS += $(srcdir)/predictor_enc.c
CSRCS += $(srcdir)/quant_enc.c
CSRCS += $(srcdir)/syntax_enc.c
CSRCS += $(srcdir)/token_enc.c
CSRCS += $(srcdir)/tree_enc.c
CSRCS += $(srcdir)/vp8l_enc.c
CSRCS += $(srcdir)/webp_enc.c
