...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DMOZ_REPLACE_MALLOC_PREFIX=profiler -DMOZ_VTUNE_INSTRUMENTATION -DOS_POSIX=1 -DOS_LINUX=1
DIRS := tests/gtest
...
LOCAL_INCLUDES += -I$(topsrcdir)/ipc/chromium/src
CPPSRCS += $(srcdir)/core/memory_hooks.cpp
CPPSRCS += $(srcdir)/core/shared-libraries-linux.cc

# We build files in 'unified' mode by including several files
# together into a single source file.  This cuts down on
# compilation times and debug information size.
UNIFIED_CPPSRCS := Unified_cpp_tools_profiler0.cpp Unified_cpp_tools_profiler1.cpp Unified_cpp_tools_profiler2.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
dist_include_mozilla_FILES += profiler_ffi_generated.h
...
LIBRARY_NAME := tools_profiler
FORCE_STATIC_LIB := 1
REAL_LIBRARY := libtools_profiler.a
DEFINES += -DMOZ_HAS_MOZGLUE -DMOZILLA_INTERNAL_API -DIMPL_LIBXUL -DSTATIC_EXPORTABLE_JS_API
COMPUTED_CFLAGS += -I/workspace/Odyssey/dist/system_wrappers -include /workspace/Odyssey/src/config/gcc_hidden.h -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fstack-protector-strong -fstack-clash-protection -DNDEBUG=1 -DTRIMMED=1 -DMOZ_REPLACE_MALLOC_PREFIX=profiler -DMOZ_VTUNE_INSTRUMENTATION -DOS_POSIX=1 -DOS_LINUX=1 -DMOZ_HAS_MOZGLUE -DMOZILLA_INTERNAL_API -DIMPL_LIBXUL -DSTATIC_EXPORTABLE_JS_API -I/workspace/Odyssey/src/tools/profiler -I/workspace/Odyssey/tools/profiler -I/workspace/Odyssey/src/caps -I/workspace/Odyssey/src/docshell/base -I/workspace/Odyssey/src/ipc/chromium/src -I/workspace/Odyssey/src/mozglue/linker -I/workspace/Odyssey/src/netwerk/base -I/workspace/Odyssey/src/netwerk/protocol/http -I/workspace/Odyssey/src/toolkit/components/jsoncpp/include -I/workspace/Odyssey/src/toolkit/crashreporter/google-breakpad/src -I/workspace/Odyssey/src/tools/profiler/core -I/workspace/Odyssey/src/tools/profiler/gecko -I/workspace/Odyssey/src/xpcom/base -I/workspace/Odyssey/ipc/ipdl/_ipdlheaders -I/workspace/Odyssey/src/ipc/chromium/src -I/workspace/Odyssey/dist/include -I/workspace/Odyssey/dist/include/nspr -I/workspace/Odyssey/dist/include/nss -include /workspace/Odyssey/mozilla-config.h -DMOZILLA_CLIENT -fPIC -fno-math-errno -pthread -pipe -gdwarf-4 -O2 -fno-omit-frame-pointer -funwind-tables -Wall -Wbitfield-enum-conversion -Wempty-body -Wformat-type-confusion -Wignored-qualifiers -Wpointer-arith -Wshadow-field-in-constructor-modified -Wsign-compare -Wtype-limits -Wno-error=tautological-type-limit-compare -Wunreachable-code -Wunreachable-code-return -Wunused-but-set-parameter -Wclass-varargs -Wfloat-overflow-conversion -Wfloat-zero-conversion -Wloop-analysis -Wno-range-loop-analysis -Wenum-compare-conditional -Wenum-float-conversion -Wstring-conversion -Wno-error=deprecated-declarations -Wno-error=array-bounds -Wno-error=free-nonheap-object -Wno-error=atomic-alignment -Wno-error=deprecated-builtins -Wformat -Wformat-security -Werror=implicit-function-declaration -Wno-psabi -Wthread-safety -Wno-unknown-warning-option -fno-strict-aliasing -ffp-contract=off
COMPUTED_CXXFLAGS += -I/workspace/Odyssey/dist/stl_wrappers -I/workspace/Odyssey/dist/system_wrappers -include /workspace/Odyssey/src/config/gcc_hidden.h -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fstack-protector-strong -fstack-clash-protection -DNDEBUG=1 -DTRIMMED=1 -DMOZ_REPLACE_MALLOC_PREFIX=profiler -DMOZ_VTUNE_INSTRUMENTATION -DOS_POSIX=1 -DOS_LINUX=1 -DMOZ_HAS_MOZGLUE -DMOZILLA_INTERNAL_API -DIMPL_LIBXUL -DSTATIC_EXPORTABLE_JS_API -I/workspace/Odyssey/src/tools/profiler -I/workspace/Odyssey/tools/profiler -I/workspace/Odyssey/src/caps -I/workspace/Odyssey/src/docshell/base -I/workspace/Odyssey/src/ipc/chromium/src -I/workspace/Odyssey/src/mozglue/linker -I/workspace/Odyssey/src/netwerk/base -I/workspace/Odyssey/src/netwerk/protocol/http -I/workspace/Odyssey/src/toolkit/components/jsoncpp/include -I/workspace/Odyssey/src/toolkit/crashreporter/google-breakpad/src -I/workspace/Odyssey/src/tools/profiler/core -I/workspace/Odyssey/src/tools/profiler/gecko -I/workspace/Odyssey/src/xpcom/base -I/workspace/Odyssey/ipc/ipdl/_ipdlheaders -I/workspace/Odyssey/src/ipc/chromium/src -I/workspace/Odyssey/dist/include -I/workspace/Odyssey/dist/include/nspr -I/workspace/Odyssey/dist/include/nss -DMOZILLA_CLIENT -include /workspace/Odyssey/mozilla-config.h -fno-sized-deallocation -fno-aligned-new -fno-exceptions -fPIC -fno-rtti -fno-exceptions -fno-math-errno -pthread -pipe -gdwarf-4 -O2 -fno-omit-frame-pointer -funwind-tables -Wall -Wbitfield-enum-conversion -Wdeprecated-this-capture -Wempty-body -Wformat-type-confusion -Wignored-qualifiers -Wpointer-arith -Wshadow-field-in-constructor-modified -Wsign-compare -Wtype-limits -Wno-error=tautological-type-limit-compare -Wunreachable-code -Wunreachable-code-return -Wunused-but-set-parameter -Wno-invalid-offsetof -Wclass-varargs -Wempty-init-stmt -Wfloat-overflow-conversion -Wfloat-zero-conversion -Wloop-analysis -Wno-range-loop-analysis -Wc++2a-compat -Wenum-compare-conditional -Wenum-float-conversion -Wno-ambiguous-reversed-operator -Wno-error=deprecated -Wno-error=deprecated-anon-enum-enum-conversion -Wno-error=deprecated-enum-enum-conversion -Wno-error=deprecated-pragma -Wno-error=deprecated-this-capture -Wcomma -Wimplicit-fallthrough -Wstring-conversion -Wno-inline-new-delete -Wno-error=deprecated-declarations -Wno-error=array-bounds -Wno-error=free-nonheap-object -Wno-error=atomic-alignment -Wno-error=deprecated-builtins -Wformat -Wformat-security -Wno-psabi -Wthread-safety -Wno-unknown-warning-option -Wno-error=stack-protector -Wno-ignored-qualifiers -fno-strict-aliasing -ffp-contract=off
