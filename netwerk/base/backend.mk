...
PRE_COMPILE_TARGETS += $(MDDEPDIR)/ascii_pac_utils.inc.stub
ascii_pac_utils.inc: $(MDDEPDIR)/ascii_pac_utils.inc.stub ;
EXTRA_MDDEPEND_FILES += $(MDDEPDIR)/ascii_pac_utils.inc.pp
$(MDDEPDIR)/ascii_pac_utils.inc.stub: /workspace/Odyssey/src/netwerk/base/makecppstring.py $(srcdir)/ascii_pac_utils.js
	$(REPORT_BUILD)
	$(call py_action,file_generate,/workspace/Odyssey/src/netwerk/base/makecppstring.py main ascii_pac_utils.inc $(MDDEPDIR)/ascii_pac_utils.inc.pp $(MDDEPDIR)/ascii_pac_utils.inc.stub $(srcdir)/ascii_pac_utils.js)
	@$(TOUCH) $@

LOCAL_INCLUDES += -I$(topobjdir)/ipc/ipdl/_ipdlheaders
LOCAL_INCLUDES += -I$(topsrcdir)/ipc/chromium/src
LOCAL_INCLUDES += -I$(topobjdir)/xpcom/components
...
LOCAL_INCLUDES += -I$(topsrcdir)/netwerk/protocol/webtransport
...
UNIFIED_CPPSRCS := Unified_cpp_netwerk_base0.cpp Unified_cpp_netwerk_base1.cpp Unified_cpp_netwerk_base2.cpp Unified_cpp_netwerk_base3.cpp Unified_cpp_netwerk_base4.cpp
