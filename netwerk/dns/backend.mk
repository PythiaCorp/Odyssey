...
PRE_COMPILE_TARGETS += $(MDDEPDIR)/etld_data.inc.stub
etld_data.inc: $(MDDEPDIR)/etld_data.inc.stub ;
EXTRA_MDDEPEND_FILES += $(MDDEPDIR)/etld_data.inc.pp
$(MDDEPDIR)/etld_data.inc.stub: /workspace/Odyssey/src/netwerk/dns/prepare_tlds.py $(srcdir)/effective_tld_names.dat
	$(REPORT_BUILD)
	$(call py_action,file_generate,/workspace/Odyssey/src/netwerk/dns/prepare_tlds.py main etld_data.inc $(MDDEPDIR)/etld_data.inc.pp $(MDDEPDIR)/etld_data.inc.stub $(srcdir)/effective_tld_names.dat)
	@$(TOUCH) $@
...
CPPSRCS += $(srcdir)/GetAddrInfo.cpp
...
# together into a single source file.  This cuts down on
# compilation times and debug information size.
UNIFIED_CPPSRCS := Unified_cpp_netwerk_dns0.cpp Unified_cpp_netwerk_dns1.cpp Unified_cpp_netwerk_dns2.cpp
