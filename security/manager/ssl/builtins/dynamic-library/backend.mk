...
PRE_COMPILE_TARGETS += $(MDDEPDIR)/libnssckbi.so.symbols.stub
libnssckbi.so.symbols: $(MDDEPDIR)/libnssckbi.so.symbols.stub ;
EXTRA_MDDEPEND_FILES += $(MDDEPDIR)/libnssckbi.so.symbols.pp
$(MDDEPDIR)/libnssckbi.so.symbols.stub: /workspace/Odyssey/src/python/mozbuild/mozbuild/action/generate_symbols_file.py $(srcdir)/builtins.symbols backend.mk
	$(REPORT_BUILD)
	$(call py_action,file_generate,/workspace/Odyssey/src/python/mozbuild/mozbuild/action/generate_symbols_file.py generate_symbols_file libnssckbi.so.symbols $(MDDEPDIR)/libnssckbi.so.symbols.pp $(MDDEPDIR)/libnssckbi.so.symbols.stub $(srcdir)/builtins.symbols -DNDEBUG=1 -DTRIMMED=1)
	@$(TOUCH) $@
