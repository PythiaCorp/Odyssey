...
CSRCS += $(srcdir)/certext.c
CSRCS += $(srcdir)/certutil.c
CSRCS += $(srcdir)/keystuff.c
...
PROGRAM = $(DEPTH)/dist/bin/certutil
PROG_IS_C_ONLY_certutil := 1
certutil_OBJS := /workspace/Odyssey/security/nss/cmd/certutil/certutil_certutil/certutil.list
$(DEPTH)/dist/bin/certutil: certutil.list
$(DEPTH)/dist/bin/certutil: certext.o \
    certutil.o \
    keystuff.o \
