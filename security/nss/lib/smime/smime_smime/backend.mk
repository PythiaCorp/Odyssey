...
CSRCS += $(srcdir)/cmsarray.c
CSRCS += $(srcdir)/cmsasn1.c
CSRCS += $(srcdir)/cmsattr.c
CSRCS += $(srcdir)/cmscinfo.c
CSRCS += $(srcdir)/cmscipher.c
CSRCS += $(srcdir)/cmsdecode.c
CSRCS += $(srcdir)/cmsdigdata.c
CSRCS += $(srcdir)/cmsdigest.c
CSRCS += $(srcdir)/cmsencdata.c
CSRCS += $(srcdir)/cmsencode.c
CSRCS += $(srcdir)/cmsenvdata.c
CSRCS += $(srcdir)/cmsmessage.c
CSRCS += $(srcdir)/cmspubkey.c
CSRCS += $(srcdir)/cmsrecinfo.c
CSRCS += $(srcdir)/cmsreclist.c
CSRCS += $(srcdir)/cmssigdata.c
CSRCS += $(srcdir)/cmssiginfo.c
CSRCS += $(srcdir)/cmsudf.c
CSRCS += $(srcdir)/cmsutil.c
CSRCS += $(srcdir)/smimemessage.c
CSRCS += $(srcdir)/smimeutil.c
CSRCS += $(srcdir)/smimever.c
