...
CSRCS += $(srcdir)/fipsaudt.c
CSRCS += $(srcdir)/fipstest.c
CSRCS += $(srcdir)/fipstokn.c
CSRCS += $(srcdir)/jpakesftk.c
CSRCS += $(srcdir)/kbkdf.c
CSRCS += $(srcdir)/lowkey.c
CSRCS += $(srcdir)/lowpbe.c
CSRCS += $(srcdir)/padbuf.c
CSRCS += $(srcdir)/pkcs11.c
CSRCS += $(srcdir)/pkcs11c.c
CSRCS += $(srcdir)/pkcs11u.c
CSRCS += $(srcdir)/sdb.c
CSRCS += $(srcdir)/sftkdb.c
CSRCS += $(srcdir)/sftkdhverify.c
CSRCS += $(srcdir)/sftkhmac.c
CSRCS += $(srcdir)/sftkike.c
CSRCS += $(srcdir)/sftkmessage.c
CSRCS += $(srcdir)/sftkpars.c
CSRCS += $(srcdir)/sftkpwd.c
CSRCS += $(srcdir)/softkver.c
CSRCS += $(srcdir)/tlsprf.c
