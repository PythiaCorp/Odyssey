...
CSRCS += $(srcdir)/alg1485.c
CSRCS += $(srcdir)/certdb.c
CSRCS += $(srcdir)/certv3.c
CSRCS += $(srcdir)/certxutl.c
CSRCS += $(srcdir)/crl.c
CSRCS += $(srcdir)/genname.c
CSRCS += $(srcdir)/polcyxtn.c
CSRCS += $(srcdir)/secname.c
CSRCS += $(srcdir)/stanpcertdb.c
CSRCS += $(srcdir)/xauthkid.c
CSRCS += $(srcdir)/xbsconst.c
CSRCS += $(srcdir)/xconst.c
