...
CSRCS += $(srcdir)/crypto.c
CSRCS += $(srcdir)/find.c
CSRCS += $(srcdir)/hash.c
CSRCS += $(srcdir)/instance.c
CSRCS += $(srcdir)/mechanism.c
CSRCS += $(srcdir)/mutex.c
CSRCS += $(srcdir)/object.c
CSRCS += $(srcdir)/session.c
CSRCS += $(srcdir)/sessobj.c
CSRCS += $(srcdir)/slot.c
CSRCS += $(srcdir)/token.c
CSRCS += $(srcdir)/wrap.c
